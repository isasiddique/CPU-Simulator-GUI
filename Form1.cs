...
namespace CpuSchedulingWinForms
{
    public  partial class Form1 : Form
    {
        ...
        private void multiLevelFeedbackQueue_Click(object sender, EventArgs e)
        {
            if (txtProcess.Text != "")
            {
                Algorithms.multilevelFeedbackQueueAlgorithm(txtProcess.Text);
            }
            else
            {
                MessageBox.Show("Enter number of processes", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void shortestRemainingTime_Click(object sender, EventArgs e)
        {
            if (txtProcess.Text != "")
            {
                Algorithms.shortestTimeRemainingFirstAlgorithm(txtProcess.Text);
            }
            else
            {
                MessageBox.Show("Enter number of processes", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
