...
namespace CpuSchedulingWinForms
{
    public static class Algorithms
    {
        ...
        public static void shortestTimeRemainingFirstAlgorithm(string userInput)
        {
            int np = Convert.ToInt16(userInput);
            int i, counter = 0;
            double total = 0.0;
        ...
        public static void multilevelFeedbackQueueAlgorithm(string userInput)
        {
            int np = Convert.ToInt16(userInput);
            int i, counter = 0;
            double total = 0.0;
            ...
            DialogResult result = MessageBox.Show("Multilevel Feedback Queue Scheduling", "", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
